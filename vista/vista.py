...
class Vista:
    def __init__(self, root, controlador):
        ...
        self.root = root
        self.root.title("gestión de tareas") #titulo de la ventana
        ...
        self.btnAgregar.grid(row=3, columnspan=2, pady=10)
    ...
    def agregar_tarea(self):
        ...
        #agregar tarea
        self.controlador.agregar_tarea(nombre, descripcion, fecha_vencimiento, estado)
    ...
    #actualiza toda la lista segun los datos dados 
    def actualizar_lista_tareas(self):
        self.lista_tareas.delete(0, END)
        for tarea in self.controlador.listar_tareas():
            self.lista_tareas.insert(END, f"{tarea.nombre} - {tarea.fecha_vencimiento} - {tarea.estado}")
